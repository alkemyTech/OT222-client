         ...
         >
            <Formik
               ...
               onSubmit={async (values, { resetForm }) => {
                  ...
                  resetForm()
                  axios.post(`${process.env.REACT_APP_SERVER_BASE_URL}/mail`, {
                     to: values.email,
                     ...
                     .then(() => { confirmation("Mensaje enviado correctamente"); setLoading(false) })
                     .catch(err => { console.log(err); error("Error", "Ha ocurrido un error al enviar el mensaje"); setLoading(false) })
                  //changeForm(true);
