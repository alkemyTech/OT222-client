        ...
        <Tbody>
            {contacts.map(contact => (
                <Tr key={contact.id}>
                    ...
                    <Td><Button size="sm" onClick={() => setEditing(contact)}>Editar</Button></Td>
                    <Td>{<Button colorScheme="red" variant="solid" size="sm" onClick={() => setDeleting(contact)}>Eliminar</Button>}</Td>
                </Tr>
            ))}
        </Tbody>
    </Table>
